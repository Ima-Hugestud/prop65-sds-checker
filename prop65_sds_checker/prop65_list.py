...
import os
_BASE_DIR = Path(os.environ.get("PROP65_DIR", Path(__file__).parent.parent))
LOCAL_CSV = _BASE_DIR / "docs" / "p65chemicalslist.csv"
CACHE_FILE = _BASE_DIR / "docs" / "prop65_cache.json"
